	        		...
	        		<h3 class="text-center"> Selamat datang di Sistem TPS </h3>
     				...
     				<div class="box-body">
     						...
     						<div class="form-group">
     								...
     								<input type="text" class="form-control" name="volume" value="<?php echo $volume['volume'] ?>">
     						...
     						<div class="form-group">
     								...
     								<input type="date" name="tanggal" class="form-control" value="<?php echo $volume['tanggal'] ?>">
     						</div>
